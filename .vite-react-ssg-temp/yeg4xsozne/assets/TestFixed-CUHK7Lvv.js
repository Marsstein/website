...
const ScrollTransformationFixed = () => {
  var _a;
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      style: { height: "300vh" },
      children: [
        /* @__PURE__ */ jsx("div", { className: "fixed top-4 left-4 z-50 bg-green-500 text-white px-3 py-1 rounded text-sm", children: "FIXED: Single Trigger Point" }),
        /* @__PURE__ */ jsx("div", { className: cn(
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-6 space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-500", children: [
              ...
              isSticky ? "Yes" : "No",
              " | Section Top: ",
              Math.round(((_a = sectionRef.current) == null ? void 0 : _a.getBoundingClientRect().top) || 0),
              "px"
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: cn(
            ...
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 max-w-md mx-auto", children: "FIXED: Einheitlicher Trigger-Point für konsistente Sticky-Position" }),
...
const TestFixed = () => {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(ScrollTransformationFixed, {}),
