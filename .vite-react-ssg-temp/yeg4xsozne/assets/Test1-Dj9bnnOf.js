...
const ScrollTransformationTest1 = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const shouldBeSticky = rect.top <= triggerPoint && rect.bottom > windowHeight;
      setIsSticky(shouldBeSticky);
      if (rect.top <= triggerPoint && rect.bottom > triggerPoint) {
        const scrolledPastTrigger = Math.max(0, triggerPoint - rect.top);
        const maxScrollDistance = sectionHeight - windowHeight;
        const progress = Math.min(scrolledPastTrigger / maxScrollDistance, 1);
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      style: { height: "300vh" },
      children: [
        /* @__PURE__ */ jsx("div", { className: "fixed top-4 left-4 z-50 bg-blue-500 text-white px-3 py-1 rounded text-sm", children: "Test 1: Einheitliche Trigger-Points" }),
        /* @__PURE__ */ jsx("div", { className: cn(
          ...
          /* @__PURE__ */ jsx("div", { className: cn(
            ...
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 max-w-md mx-auto", children: "Test 1: Einheitliche Trigger-Points für Sticky und Progress" }),
...
const Test1 = () => {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(ScrollTransformationTest1, {}),
