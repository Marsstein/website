...
import { ChevronRight, FileCheck, BarChart3, Target, BookOpen, Play, Download, Share2, Printer, Clock, Users, Star, CheckCircle, ArrowLeft, ArrowRight, CheckCircle2 } from "lucide-react";
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 mb-6 text-sm", children: [
                  /* @__PURE__ */ jsx(Link, { to: "/wissen", className: "text-slate-400 hover:text-purple-300 transition-colors", children: "Wissen" }),
                  /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-slate-500" }),
                  /* @__PURE__ */ jsx(Link, { to: "/wissen/dsgvo", className: "text-slate-400 hover:text-purple-300 transition-colors", children: "DSGVO" }),
                  /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-slate-500" }),
                  /* @__PURE__ */ jsx("span", { className: "text-purple-300", children: "DSFA durchführen" })
                ] }),
                /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(FileCheck, { className: "h-5 w-5 text-purple-400" }),
                      /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-purple-300", children: "DSFA-Leitfaden" }),
                ...
                /* @__PURE__ */ jsxs("h1", { className: "text-4xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-white", children: "Datenschutz-" }),
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 bg-clip-text text-transparent", children: "Folgenabschätzung" }),
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "text-white", children: "durchführen" })
                ] }),
                /* @__PURE__ */ jsxs("p", { className: "text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-8", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "font-semibold text-purple-300", children: "systematische DSFA" }),
                  " nach Art. 35 DSGVO"
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-6 mb-8", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-4 py-2 bg-slate-800/60 rounded-full backdrop-blur-sm", children: [
                    /* @__PURE__ */ jsx(Target, { className: "h-4 w-4 text-pink-400" }),
                    /* @__PURE__ */ jsx("span", { className: "text-sm text-slate-300", children: "Fortgeschritten" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-4 py-2 bg-slate-800/60 rounded-full backdrop-blur-sm", children: [
                    /* @__PURE__ */ jsx(BookOpen, { className: "h-4 w-4 text-red-400" }),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6 text-sm text-slate-400", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { children: "987 Leser" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Star, { className: "h-4 w-4 text-yellow-400 fill-current" }),
                  /* @__PURE__ */ jsx("span", { children: "4.6 Bewertung" })
                ] }),
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: chapters.map((chapter, index) => /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  index === currentChapter ? "bg-purple-500/20 border border-purple-500/30 text-purple-300" : "hover:bg-slate-700/50 text-slate-300"
                ),
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsx("div", { className: cn(
                    "w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium",
                    completedChapters.includes(index) ? "bg-green-500 text-white" : index === currentChapter ? "bg-purple-500 text-white" : "bg-slate-700 text-slate-400"
...
export {
  DsfaDurchfuehrungGuide as default
};
