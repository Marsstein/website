...
const ScrollTransformationApproach1 = () => {
  ...
  const handleScroll = useCallback(() => {
    ...
    const stickyStartY = sectionTop - 64;
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      style: { height: "300vh" },
      children: [
        /* @__PURE__ */ jsx("div", { className: "fixed top-4 left-4 z-50 bg-blue-600 text-white px-3 py-1 rounded text-sm", children: "APPROACH 1: Intersection Observer" }),
        /* @__PURE__ */ jsx("div", { className: cn(
          "w-full transition-all duration-150",
          // Shorter transition for responsiveness
          ...
          /* @__PURE__ */ jsx("div", { className: cn(
            ...
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 max-w-md mx-auto", children: "APPROACH 1: Intersection Observer für präzise Scroll-Detection" }),
...
const TestApproach1 = () => {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(ScrollTransformationApproach1, {}),
