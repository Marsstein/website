...
const ScrollTransformationOptimized = () => {
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      style: { height: "300vh" },
      children: [
        /* @__PURE__ */ jsx("div", { className: "fixed top-4 left-4 z-50 bg-blue-700 text-white px-3 py-1 rounded text-sm", children: "MULTI-SCROLL FIX: Dynamic Boundaries" }),
        /* @__PURE__ */ jsx(
          "div",
          {
            className: cn(
            ...
            children: /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-white", style: { overflowY: "auto", overflowX: "hidden" }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-6xl px-4 py-8", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-center mb-6 space-y-3", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 max-w-3xl mx-auto", children: debugInfo })
              ] }),
              ...
              /* @__PURE__ */ jsx("div", { className: cn(
                ...
                /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 max-w-md mx-auto", children: "MULTI-SCROLL FIX: Dynamische Boundary-Berechnung für konsistente Sticky-Position" }),
...
const TestOptimized = () => {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(ScrollTransformationOptimized, {}),
