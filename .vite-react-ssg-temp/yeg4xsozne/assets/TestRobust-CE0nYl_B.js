...
import { Shield, Euro, Zap, Clock, Brain, TrendingUp, Database, FileCheck, AlertTriangle, CheckCircle2, Sparkles, Rocket, ArrowRight } from "lucide-react";
...
const ScrollTransformationRobust = () => {
  ...
  const handleScroll = useCallback(() => {
    ...
    setDebugInfo(
      `ROBUST SOLUTION | ScrollY: ${Math.round(scrollY)} | SectionTop: ${Math.round(sectionTop)} | Range: ${Math.round(stickyStartY)}-${Math.round(stickyEndY)} | Progress: ${Math.round(progress * 100)}% | Sticky: ${stickyState ? "YES" : "NO"} | Renders: ${renderCount.current}`
    );
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      style: { height: "300vh" },
      children: [
        /* @__PURE__ */ jsx("div", { className: "fixed top-4 left-4 z-50 bg-green-600 text-white px-3 py-1 rounded text-sm", children: "✅ ROBUST: Fixed overflow:hidden" }),
        /* @__PURE__ */ jsx(
          "div",
          {
            className: cn(
            ...
            children: /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-white", style: {
              overflow: "hidden",
              // We control overflow here, not the parent
              position: "relative"
            }, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-6xl px-4 py-8 h-full overflow-y-auto", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-center mb-6 space-y-3", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 max-w-4xl mx-auto", children: debugInfo })
              ] }),
              ...
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-4xl mx-auto mb-8", children: cardElements }),
              ...
              /* @__PURE__ */ jsx("div", { className: cn(
                ...
                /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 max-w-md mx-auto", children: "ROBUST: offsetTop-basierte Berechnung umgeht overflow:hidden + 95% weniger Renders" }),
...
const TestRobust = () => {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(ScrollTransformationRobust, {}),
