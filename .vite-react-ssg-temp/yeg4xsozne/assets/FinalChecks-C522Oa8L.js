...
const FinalChecks = () => {
  ...
  const createCheckItems = (pageId, isFirstFive = false) => ({
  ...
  const toggleCheckItem = (categoryId, pageIndex, checkType) => {
    setPageChecks(
      (prev) => prev.map(
        (category) => category.id === categoryId ? {
          ...category,
          pages: category.pages.map(
            (page, index) => index === pageIndex ? {
              ...page,
              [checkType]: {
                ...page[checkType],
                completed: !page[checkType].completed
              }
            } : page
          )
        } : category
  ...
  const calculateCategoryCompletion = (category) => {
    const totalChecks2 = category.pages.length * 5;
    const completedChecks2 = category.pages.reduce((acc, page) => {
      return acc + [page.mobileReady, page.seoOptimized, page.contentReady, page.performanceOptimized, page.accessibilityCompliant].filter((check) => check.completed).length;
    }, 0);
    return Math.round(completedChecks2 / totalChecks2 * 100);
  };
  const totalPages = pageChecks.reduce((acc, cat) => acc + cat.pages.length, 0);
  const totalChecks = totalPages * 5;
  const completedChecks = pageChecks.reduce(
    (acc, cat) => acc + cat.pages.reduce(
      (pageAcc, page) => pageAcc + [page.mobileReady, page.seoOptimized, page.contentReady, page.performanceOptimized, page.accessibilityCompliant].filter((check) => check.completed).length,
      0
    ),
    0
  );
  const overallCompletion = Math.round(completedChecks / totalChecks * 100);
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50 py-8 px-4", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "bg-gray-100 rounded-lg p-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 border-b-4 border-blue-600 pb-2", children: "🎯 Final Checks - Launch Readiness" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 mt-2", children: "Mobile Freundlichkeit, SEO Optimierung & Content Readiness Checkliste" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mt-4 lg:mt-0", children: /* @__PURE__ */ jsx("div", { className: "bg-white p-4 rounded-lg shadow", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-3xl font-bold text-blue-600", children: [
          overallCompletion,
          "%"
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Gesamt-Fortschritt" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 p-4 rounded-lg mb-8", children: [
      /* @__PURE__ */ jsx("h3", { className: "font-semibold text-blue-900 mb-2", children: "📋 Checkliste pro Seite:" }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-2 text-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "w-3 h-3 bg-blue-500 rounded mr-2" }),
          "📱 Mobile Responsive"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "w-3 h-3 bg-green-500 rounded mr-2" }),
          "🔍 SEO Optimiert"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "w-3 h-3 bg-purple-500 rounded mr-2" }),
          "📝 Content Ready"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "w-3 h-3 bg-orange-500 rounded mr-2" }),
          "⚡ Performance"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "w-3 h-3 bg-pink-500 rounded mr-2" }),
          "♿ Barrierefreiheit"
        ] })
      ] })
    ] }),
    pageChecks.map((category) => {
      ...
      return /* @__PURE__ */ jsxs("div", { className: "mb-6 border border-gray-300 rounded-lg bg-white", children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("span", { className: "flex items-center", children: [
              ...
              " ",
              category.title,
              /* @__PURE__ */ jsxs("span", { className: "ml-3 px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full", children: [
                categoryCompletion,
                "% Complete"
              ] }),
              /* @__PURE__ */ jsxs("span", { className: "ml-2 text-sm font-normal text-gray-600", children: [
                "(",
        ...
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("div", { className: "p-4", children: category.pages.map((page, pageIndex) => {
          const pageCompletion = calculatePageCompletion(page);
          return /* @__PURE__ */ jsxs("div", { className: `mb-6 p-4 rounded-lg border-l-4 ${getPriorityColor(page.priority)} bg-gray-50`, children: [
            /* @__PURE__ */ jsx("div", { className: "flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-2", children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: "ml-2 px-2 py-1 text-xs rounded-full bg-white border", children: [
                  pageCompletion,
                  "% ✓"
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-500 mb-1", children: [
                "URL: ",
                /* @__PURE__ */ jsx("code", { className: "bg-gray-200 px-1 rounded break-all text-xs", children: page.url })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600 mb-2 break-words leading-relaxed", children: page.description }),
              page.titleTag && /* @__PURE__ */ jsxs("div", { className: "mt-2 p-3 bg-blue-50 rounded border border-blue-200 overflow-hidden", children: [
                /* @__PURE__ */ jsxs("div", { className: "text-xs font-semibold text-blue-800 mb-1", children: [
                  "Title Tag (",
                  page.titleTag.length,
                  " Zeichen):"
                ] }),
                /* @__PURE__ */ jsx("div", { className: "text-xs text-blue-700 break-words whitespace-normal leading-relaxed", children: page.titleTag })
              ] }),
              page.metaDescription && /* @__PURE__ */ jsxs("div", { className: "mt-2 p-3 bg-green-50 rounded border border-green-200 overflow-hidden", children: [
                /* @__PURE__ */ jsxs("div", { className: "text-xs font-semibold text-green-800 mb-1", children: [
                  "Meta Description (",
                  page.metaDescription.length,
                  " Zeichen):"
                ] }),
                /* @__PURE__ */ jsx("div", { className: "text-xs text-green-700 break-words whitespace-normal leading-relaxed", children: page.metaDescription })
              ] }),
              page.indexStatus && /* @__PURE__ */ jsxs("div", { className: "mt-2 p-3 bg-purple-50 rounded border border-purple-200 overflow-hidden", children: [
                /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold text-purple-800 mb-1", children: "Index Status:" }),
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3", children: [
              ...
              const checkItem = page[key];
              return /* @__PURE__ */ jsxs(
                "div",
                {
                  className: `p-3 rounded border cursor-pointer transition-all ${checkItem.completed ? "bg-green-50 border-green-200 hover:bg-green-100" : "bg-white border-gray-200 hover:bg-gray-50"}`,
                  onClick: () => toggleCheckItem(category.id, pageIndex, key),
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-lg", children: icon }),
                      /* @__PURE__ */ jsx("span", { className: `text-lg ${checkItem.completed ? "text-green-500" : "text-gray-300"}`, children: checkItem.completed ? "✅" : "⭕" })
                    ] }),
                    /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-600 leading-tight break-words", children: checkItem.title })
                  ]
                },
                key
              );
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-4", children: "🚀 Launch Readiness Status" }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center p-4 bg-white rounded-lg", children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-blue-600", children: totalPages }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Seiten gesamt" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "text-center p-4 bg-white rounded-lg", children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-green-600", children: completedChecks }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Checks abgeschlossen" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "text-center p-4 bg-white rounded-lg", children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-purple-600", children: totalChecks - completedChecks }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: "Checks verbleibend" })
        ] })
      ] }),
      overallCompletion === 100 && /* @__PURE__ */ jsx("div", { className: "mt-4 p-4 bg-green-100 border border-green-300 rounded-lg text-center", children: /* @__PURE__ */ jsx("div", { className: "text-green-800 font-semibold", children: "🎉 Glückwunsch! Alle Checks sind abgeschlossen. Die Website ist launch-ready!" }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200", children: [
      /* @__PURE__ */ jsx("h4", { className: "font-semibold text-yellow-900 mb-2", children: "💡 Verwendung:" }),
      /* @__PURE__ */ jsxs("div", { className: "text-sm text-yellow-800 space-y-1", children: [
        /* @__PURE__ */ jsx("p", { children: "• Kategorie aufklappen → Seite über Link öffnen → Prüfungen durchführen → Checkbox abhaken" }),
        /* @__PURE__ */ jsx("p", { children: "• Jede Seite hat 5 Checks: Mobile Responsive, SEO, Content, Performance, Barrierefreiheit" }),
        /* @__PURE__ */ jsx("p", { children: "• Der Fortschritt wird automatisch berechnet und gespeichert während der Session" })
      ] })
    ] })
  ] }) }) });
};
export {
  FinalChecks as default
};
