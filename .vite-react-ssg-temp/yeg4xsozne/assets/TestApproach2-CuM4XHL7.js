...
const ScrollTransformationApproach2 = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const animationStart = sectionTop - 64;
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "fixed top-4 left-4 z-50 bg-orange-600 text-white px-3 py-1 rounded text-sm", children: "APPROACH 2: Transform statt Sticky" }),
        /* @__PURE__ */ jsx(
          "div",
          {
            ref: contentRef,
            ...
            children: /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-white", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-6xl px-4 py-8", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: cn(
                ...
                /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 max-w-md mx-auto", children: "APPROACH 2: Transform statt Sticky CSS für bessere Performance" }),
...
const TestApproach2 = () => {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(ScrollTransformationApproach2, {}),
