...
import { ChevronRight, Shield, Settings, Target, BookOpen, Bookmark, Play, Download, Share2, Printer, Clock, Users, Star, CheckCircle, ArrowLeft, ArrowRight, CheckCircle2, FileCheck, Database, UserCheck, ExternalLink } from "lucide-react";
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900", children: [
      ...
      /* @__PURE__ */ jsx(
        motion.section,
        {
          ...
          children: /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-4xl relative z-10", children: /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 mb-6 text-sm", children: [
                  /* @__PURE__ */ jsx(Link, { to: "/wissen", className: "text-slate-400 hover:text-blue-300 transition-colors", children: "Wissen" }),
                  /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-slate-500" }),
                  /* @__PURE__ */ jsx(Link, { to: "/wissen/dsgvo", className: "text-slate-400 hover:text-blue-300 transition-colors", children: "DSGVO" }),
                  /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-slate-500" }),
                  /* @__PURE__ */ jsx("span", { className: "text-blue-300", children: "TOM-Maßnahmen" })
                ] }),
                /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-blue-300", children: "TOM-Leitfaden" }),
                      /* @__PURE__ */ jsx(Settings, { className: "h-5 w-5 text-indigo-400" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs("h1", { className: "text-4xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-white", children: "Technische &" }),
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent", children: "Organisatorische" }),
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "text-white", children: "Maßnahmen" })
                ] }),
                /* @__PURE__ */ jsxs("p", { className: "text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-8", children: [
                  "Comprehensive Guide für die Implementierung angemessener ",
                  /* @__PURE__ */ jsx("span", { className: "font-semibold text-blue-300", children: "Sicherheitsmaßnahmen" }),
                  " nach Art. 32 DSGVO"
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-6 mb-8", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-4 py-2 bg-slate-800/60 rounded-full backdrop-blur-sm", children: [
                    /* @__PURE__ */ jsx(Target, { className: "h-4 w-4 text-green-400" }),
                    /* @__PURE__ */ jsx("span", { className: "text-sm text-slate-300", children: "Fortgeschritten" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-4 py-2 bg-slate-800/60 rounded-full backdrop-blur-sm", children: [
                    /* @__PURE__ */ jsx(BookOpen, { className: "h-4 w-4 text-purple-400" }),
                  ...
                  /* @__PURE__ */ jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx(Bookmark, { className: cn("h-4 w-4", bookmarked ? "text-yellow-400 fill-current" : "text-slate-400") }),
                        /* @__PURE__ */ jsx("span", { className: "text-sm text-slate-300", children: "Merken" })
                      ]
                    }
                  )
                ] }),
      ...
      /* @__PURE__ */ jsx("section", { ref: contentRef, className: "py-16 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-7xl", children: [
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 30 },
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Button, { size: "sm", variant: "outline", className: "border-slate-600 text-slate-400 hover:text-white", children: /* @__PURE__ */ jsx(Share2, { className: "h-4 w-4" }) }),
                  /* @__PURE__ */ jsx(Button, { size: "sm", variant: "outline", className: "border-slate-600 text-slate-400 hover:text-white", children: /* @__PURE__ */ jsx(Printer, { className: "h-4 w-4" }) }),
                  /* @__PURE__ */ jsx(Button, { size: "sm", variant: "outline", className: "border-slate-600 text-slate-400 hover:text-white", children: /* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }) })
                ] })
              ] }),
              /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4 text-white", children: currentChapterData.title }),
              /* @__PURE__ */ jsx("p", { className: "text-xl text-slate-300 mb-6", children: currentChapterData.subtitle }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6 text-sm text-slate-400", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { children: "2,134 Leser" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Star, { className: "h-4 w-4 text-yellow-400 fill-current" }),
                  /* @__PURE__ */ jsx("span", { children: "4.8 Bewertung" })
                ] }),
                completedChapters.includes(currentChapter) && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-green-400", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-4 gap-6 lg:gap-8", children: [
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsx("div", { className: "lg:sticky lg:top-40", children: /* @__PURE__ */ jsx(Card, { className: "bg-slate-800/60 border-slate-700/50", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-semibold text-white mb-4", children: "Kapitel" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: chapters.map((chapter, index) => /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => setCurrentChapter(index),
                className: cn(
                  "w-full text-left p-3 rounded-lg transition-all duration-200",
                  index === currentChapter ? "bg-blue-500/20 border border-blue-500/30 text-blue-300" : "hover:bg-slate-700/50 text-slate-300"
                ),
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsx("div", { className: cn(
                    "w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium",
                    completedChapters.includes(index) ? "bg-green-500 text-white" : index === currentChapter ? "bg-blue-500 text-white" : "bg-slate-700 text-slate-400"
                  ), children: completedChapters.includes(index) ? /* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4" }) : index + 1 }),
                  /* @__PURE__ */ jsx("div", { className: "flex-grow", children: /* @__PURE__ */ jsx("div", { className: "text-sm font-medium", children: chapter.title }) })
                ] })
              },
              chapter.id
            )) }),
            /* @__PURE__ */ jsxs("div", { className: "mt-6 pt-4 border-t border-slate-700", children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm text-slate-400 mb-2", children: "Gesamtfortschritt" }),
              /* @__PURE__ */ jsx(Progress, { value: completedChapters.length / chapters.length * 100, className: "h-2 mb-2" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-3", children: /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(Card, { className: "bg-slate-800/60 border-slate-700/50 mb-8 overflow-hidden", children: /* @__PURE__ */ jsx(CardContent, { className: "p-4 lg:p-8", children: /* @__PURE__ */ jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-0", children: [
                  /* @__PURE__ */ jsxs(
                    Button,
                    {
                      variant: "outline",
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 lg:gap-4 order-first lg:order-none", children: [
                    ...
                    completedChapters.includes(currentChapter) && /* @__PURE__ */ jsxs(Badge, { className: "bg-green-500/20 text-green-300", children: [
                      /* @__PURE__ */ jsx(CheckCircle, { className: "h-3 w-3 mr-1" }),
                      "Abgeschlossen"
                    ] })
                  ] }),
                  currentChapter < chapters.length - 1 ? /* @__PURE__ */ jsxs(
                    Button,
                    {
                      onClick: nextChapter,
                  ...
                  ) : /* @__PURE__ */ jsxs(Button, { className: "bg-gradient-to-r from-green-500 to-emerald-500 text-white", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-blue-900/30", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-6xl", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-2xl md:text-3xl font-bold text-center mb-12", children: /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent", children: "Weiterführende Leitfäden" }) }),
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6", children: [
          ...
          motion.div,
          {
            ...
            whileHover: { y: -5 },
            children: /* @__PURE__ */ jsx(Card, { className: "h-full bg-slate-800/80 backdrop-blur-sm border-slate-700/50 hover:border-slate-600/50 transition-all duration-300", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
              /* @__PURE__ */ jsx("div", { className: cn(
                "inline-flex p-3 rounded-2xl bg-gradient-to-r mb-4",
                guide.color
              ), children: /* @__PURE__ */ jsx(guide.icon, { className: "h-6 w-6 text-white" }) }),
              /* @__PURE__ */ jsx("h4", { className: "text-xl font-semibold mb-3 text-white", children: guide.title }),
