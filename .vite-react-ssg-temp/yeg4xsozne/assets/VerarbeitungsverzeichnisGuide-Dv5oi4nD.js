...
import { Database, Bookmark, Share2, Download, ClipboardList, Clock, Users, Star, CheckCircle, ArrowLeft, ArrowRight } from "lucide-react";
...
const VerarbeitungsverzeichnisGuide = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900", style: {
      ...
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsx("div", { className: "fixed top-16 left-0 right-0 z-40 bg-slate-900/90 backdrop-blur-sm border-b border-slate-800", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-7xl px-4 py-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxs(Badge, { className: "bg-orange-500/20 text-orange-300", children: [
              /* @__PURE__ */ jsx(Database, { className: "h-3 w-3 mr-1" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsx(Bookmark, { className: cn("h-4 w-4", bookmarked && "fill-current") })
                }
              ),
              /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", className: "text-slate-400", children: /* @__PURE__ */ jsx(Share2, { className: "h-4 w-4" }) }),
              /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "sm", className: "text-slate-400", children: /* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx(Progress, { value: overallProgress, className: "h-2" })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "pt-32 pb-16 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-7xl", children: [
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
                /* @__PURE__ */ jsx("div", { className: "p-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl", children: /* @__PURE__ */ jsx(ClipboardList, { className: "h-8 w-8 text-white" }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h1", { className: "text-3xl md:text-4xl font-bold text-white", children: currentChapterData.title }),
                  /* @__PURE__ */ jsx("p", { className: "text-xl text-orange-300", children: currentChapterData.subtitle })
                ] })
              ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-4 gap-6 lg:gap-8", children: [
          /* @__PURE__ */ jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsx("div", { className: "lg:sticky lg:top-40", children: /* @__PURE__ */ jsx(Card, { className: "bg-slate-800/60 border-slate-700/50", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: chapters.map((chapter, index) => /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  index === currentChapter ? "bg-orange-500/20 border border-orange-500/30 text-orange-300" : "hover:bg-slate-700/50 text-slate-300"
                ),
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsx("div", { className: cn(
                    "w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium",
                    completedChapters.includes(index) ? "bg-green-500 text-white" : index === currentChapter ? "bg-orange-500 text-white" : "bg-slate-700 text-slate-400"
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-6 pt-4 border-t border-slate-700", children: [
              ...
              /* @__PURE__ */ jsx(Progress, { value: overallProgress, className: "h-2 mb-2" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-0", children: [
                  ...
                  currentChapter < chapters.length - 1 ? /* @__PURE__ */ jsxs(
                    ...
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxs(Link, { to: "/wissen/leitfaden/betroffenenrechte", children: [
                        "Nächster Leitfaden",
                        /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 ml-2" })
                      ] })
                    }
...
export {
  VerarbeitungsverzeichnisGuide as default
};
