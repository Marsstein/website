...
const ScrollTransformationBidirectional = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const stickyEndY = sectionBottom - windowHeight;
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      style: { height: "300vh" },
      children: [
        /* @__PURE__ */ jsx("div", { className: "fixed top-4 left-4 z-50 bg-cyan-600 text-white px-3 py-1 rounded text-sm", children: "BIDIRECTIONAL: Math-Based" }),
        /* @__PURE__ */ jsx("div", { className: cn(
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-6 space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-500 max-w-2xl mx-auto", children: [
              "Progress: ",
          ...
          /* @__PURE__ */ jsx("div", { className: cn(
            ...
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 max-w-md mx-auto", children: "BIDIRECTIONAL: Mathematisch korrekte Berechnungen für beide Scroll-Richtungen" }),
...
const TestBidirectional = () => {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(ScrollTransformationBidirectional, {}),
