...
import { Globe, Shield, Target, CheckCircle2, Clock, ArrowLeft, Bookmark, ArrowRight } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900", children: [
    ...
    /* @__PURE__ */ jsx(
      motion.section,
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-7xl px-4 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              initial: { scale: 0 },
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-purple-300", children: "Website DSGVO Guide" }),
                /* @__PURE__ */ jsx(Shield, { className: "h-5 w-5 text-pink-400" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs("h1", { className: "text-4xl md:text-6xl font-black tracking-tight mb-6", children: [
            /* @__PURE__ */ jsx("span", { className: "text-white", children: "Website" }),
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 bg-clip-text text-transparent", children: "DSGVO-konform" }),
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("span", { className: "text-white", children: "gestalten" })
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-8", children: [
            "Cookie-Banner, Privacy Policy, Analytics und mehr - ",
            /* @__PURE__ */ jsx("span", { className: "font-semibold text-purple-300", children: "rechtssicher umsetzen" }),
            "und teure Abmahnungen vermeiden."
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap justify-center gap-4 mb-8", children: /* @__PURE__ */ jsxs(Badge, { className: "bg-pink-500/20 text-pink-300 border-pink-500/30", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-7xl px-4 py-8", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-4 gap-8", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsx("div", { className: "lg:sticky lg:top-24", style: { maxHeight: "calc(100vh - 8rem)", overflowY: "auto" }, children: /* @__PURE__ */ jsx(Card, { className: "bg-slate-800/80 backdrop-blur-sm border-slate-700/50 h-fit", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-white mb-4", children: "Inhaltsverzeichnis" }),
        /* @__PURE__ */ jsx("div", { className: "space-y-2 max-h-[calc(100vh-16rem)] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800", children: chapters.map((chapter, index) => /* @__PURE__ */ jsx(
          motion.button,
          {
            whileHover: { x: 4 },
            ...
            className: cn(
              ...
              currentChapter === index ? "bg-purple-500/20 border-purple-500/50 text-purple-300" : "border-slate-700/50 text-slate-400 hover:bg-slate-700/50 hover:text-slate-300"
            ),
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: cn(
                "w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold",
                completedChapters.includes(index) ? "bg-green-500 text-white" : currentChapter === index ? "bg-purple-500 text-white" : "bg-slate-600 text-slate-400"
              ), children: completedChapters.includes(index) ? /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }) : index + 1 }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3", children: [
        /* @__PURE__ */ jsx(Card, { className: "bg-slate-800/80 backdrop-blur-sm border-slate-700/50 mb-8", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mt-12 pt-8 border-t border-slate-700/50", children: [
            /* @__PURE__ */ jsxs(
              Button,
              {
                variant: "outline",
          ...
          /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-4", children: [
            ...
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("h4", { className: "font-semibold text-white group-hover:text-purple-300 transition-colors", children: guide.title }),
