...
import { Scale, Users, Building2, Globe, Shield, Phone, Bell, Award, Share2, Flag, TrendingUp, MessageSquare, FileText, Download, Edit3, CheckCircle2, Eye, Copy, Settings, Send, ArrowRight, ArrowLeft } from "lucide-react";
...
const CommunicationTemplatesGuide = () => {
...
[UNTERNEHMEN]`
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Helmet, { children: [
      /* @__PURE__ */ jsx("title", { children: "Krisenkommunikation Templates – DSGVO Vorlagen & Muster | Marsstein" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Professionelle Kommunikationsvorlagen für Krisen: Behördenmeldung, Kundenkommunikation & Mitarbeiterinfo. DSGVO-konform. Jetzt kostenlos!" }),
      /* @__PURE__ */ jsx("meta", { name: "keywords", content: "Krisenkommunikation, DSGVO Templates, Behördenmeldung, Data Breach Kommunikation, Notfallvorlagen, PR Krise" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Krisenkommunikation Templates – DSGVO Vorlagen & Muster" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Professionelle Kommunikationsvorlagen für Krisen: Behördenmeldung, Kundenkommunikation & Mitarbeiterinfo. DSGVO-konform." }),
      /* @__PURE__ */ jsx("meta", { property: "og:type", content: "article" }),
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: "https://marsstein.de/wissen/krisenmanagement/communication-templates" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:card", content: "summary_large_image" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Krisenkommunikation Templates – DSGVO Vorlagen & Muster" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Professionelle Kommunikationsvorlagen für Krisen: Behördenmeldung, Kundenkommunikation & Mitarbeiterinfo. DSGVO-konform." }),
      /* @__PURE__ */ jsx("meta", { name: "viewport", content: "width=device-width, initial-scale=1" }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://marsstein.de/wissen/krisenmanagement/communication-templates" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900", children: [
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsx(
        motion.section,
        {
              ...
              children: [
                /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(MessageSquare, { className: "h-5 w-5 text-teal-400" }),
                      /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-teal-300", children: "Crisis Communication" }),
                ...
                /* @__PURE__ */ jsxs(
                  motion.h1,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("br", {}),
                      /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent", children: "Kommunikation" }),
                      /* @__PURE__ */ jsx("br", {}),
                      /* @__PURE__ */ jsx("span", { className: "text-white", children: "Templates" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs(
                  motion.p,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("span", { className: "font-semibold text-teal-300", children: "Sofort einsetzbare Vorlagen" }),
                      " für professionelle Kommunikation in Datenschutz- und Sicherheitskrisen."
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs(Button, { size: "lg", className: "bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white px-8 py-4 text-lg font-semibold", children: [
                        /* @__PURE__ */ jsx(Download, { className: "mr-2 h-5 w-5" }),
                        "Alle Templates laden"
                      ] }),
                      /* @__PURE__ */ jsxs(Button, { size: "lg", variant: "outline", className: "border-2 border-teal-500/30 hover:border-teal-400 text-teal-300 hover:bg-teal-500/10 px-8 py-4 text-lg font-semibold backdrop-blur-sm", children: [
                        /* @__PURE__ */ jsx(Edit3, { className: "mr-2 h-5 w-5" }),
                        "Template anpassen"
                      ] })
                    ]
                  }
          ...
          children: categories.map((category, index) => /* @__PURE__ */ jsxs(
            motion.button,
            {
              ...
              className: cn(
                ...
                selectedCategory === category.id ? "bg-gradient-to-r from-teal-500 to-cyan-500 text-white border-teal-500 shadow-xl" : "bg-slate-800/60 text-slate-300 border-slate-700/50 hover:border-teal-500/50 hover:text-teal-300"
              ),
              children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-7xl", children: /* @__PURE__ */ jsx("div", { className: "grid lg:grid-cols-2 gap-8", children: filteredTemplates.map((template, index) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Card, { className: "h-full border-2 border-slate-700/50 bg-slate-800/80 transition-all duration-500 group-hover:shadow-2xl overflow-hidden", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-8", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-6", children: [
                /* @__PURE__ */ jsx(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsx(template.icon, { className: "h-8 w-8 text-white" })
                  }
                ),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 items-end", children: [
                  /* @__PURE__ */ jsx(Badge, { className: getUrgencyColor(template.urgency), children: template.urgency }),
                  /* @__PURE__ */ jsx(Badge, { className: "bg-slate-700 text-slate-200 border-0 text-xs", children: template.timeframe })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold mb-3 text-white group-hover:text-teal-300 transition-colors", children: template.title }),
                /* @__PURE__ */ jsx("p", { className: "text-slate-300 mb-4 leading-relaxed", children: template.description }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4 mb-4 p-4 bg-slate-700/50 rounded-xl", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-slate-300 mb-1", children: "Empfänger" }),
                    /* @__PURE__ */ jsx("div", { className: "text-xs text-slate-400", children: template.recipient })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-slate-300 mb-1", children: "Format" }),
                    /* @__PURE__ */ jsx("div", { className: "text-xs text-slate-400", children: template.format })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
                  /* @__PURE__ */ jsx("h4", { className: "text-sm font-semibold text-slate-300 mb-3", children: "Benötigte Informationen:" }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    template.requiredInfo.slice(0, 3).map((info, idx) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
                      /* @__PURE__ */ jsx(CheckCircle2, { className: "w-4 h-4 text-teal-400 flex-shrink-0 mt-0.5" }),
                      /* @__PURE__ */ jsx("span", { className: "text-xs text-slate-400", children: info })
                    ] }, idx)),
                    template.requiredInfo.length > 3 && /* @__PURE__ */ jsxs("div", { className: "text-xs text-slate-500", children: [
                      "+",
              ...
              selectedTemplate === template.id && /* @__PURE__ */ jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                      /* @__PURE__ */ jsx("h4", { className: "text-sm font-semibold text-white", children: "Template Inhalt:" }),
                    ...
                    /* @__PURE__ */ jsx("pre", { className: "text-xs text-slate-300 whitespace-pre-wrap font-mono bg-slate-800/50 p-4 rounded-lg max-h-96 overflow-y-auto", children: template.template })
                  ]
                }
              )
            ] }) })
      ...
      /* @__PURE__ */ jsxs("section", { className: "py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-slate-800/50 via-teal-900/30 to-slate-800/50" }),
        /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-7xl relative z-10", children: [
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              className: "text-center mb-16",
              children: [
                /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-6", children: /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent", children: "Sofort-Tools" }) }),
          ...
          /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-8", children: [
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsx(Card, { className: "h-full bg-slate-800/80 backdrop-blur-sm border-2 border-slate-700/50 hover:shadow-xl transition-all duration-300", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-8", children: [
                ...
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold mb-3 text-white", children: tool.title }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto max-w-7xl", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
        ...
        /* @__PURE__ */ jsx(Button, { asChild: true, className: "bg-gradient-to-r from-teal-500 to-cyan-500 text-white", children: /* @__PURE__ */ jsxs(Link, { to: "/wissen/krisenmanagement/media-crisis", children: [
          "Media Crisis Guide",
          /* @__PURE__ */ jsx(ArrowRight, { className: "ml-2 h-4 w-4" })
        ] }) })
      ] }) }) }),
...
export {
  CommunicationTemplatesGuide as default
};
