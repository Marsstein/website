...
import { UserCheck, Bookmark, Share2, Download, Clock, Users, Star, CheckCircle, ArrowLeft, ArrowRight } from "lucide-react";
      ...
      /* @__PURE__ */ jsx("div", { className: "fixed top-16 left-0 right-0 z-40 bg-slate-900/90 backdrop-blur-sm border-b border-slate-800", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto max-w-7xl px-4 py-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxs(Badge, { className: "bg-teal-500/20 text-teal-300", children: [
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
                /* @__PURE__ */ jsx("div", { className: "p-3 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-xl", children: /* @__PURE__ */ jsx(UserCheck, { className: "h-8 w-8 text-white" }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h1", { className: "text-3xl md:text-4xl font-bold text-white", children: currentChapterData.title }),
                  /* @__PURE__ */ jsx("p", { className: "text-xl text-teal-300", children: currentChapterData.subtitle })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6 text-sm text-slate-400", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { children: "1,789 Leser" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Star, { className: "h-4 w-4 text-yellow-400 fill-current" }),
                  /* @__PURE__ */ jsx("span", { children: "4.7 Bewertung" })
                ] }),
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: chapters.map((chapter, index) => /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  index === currentChapter ? "bg-teal-500/20 border border-teal-500/30 text-teal-300" : "hover:bg-slate-700/50 text-slate-300"
                ),
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsx("div", { className: cn(
                    "w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium",
                    completedChapters.includes(index) ? "bg-green-500 text-white" : index === currentChapter ? "bg-teal-500 text-white" : "bg-slate-700 text-slate-400"
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-0", children: [
                  ...
                  currentChapter < chapters.length - 1 ? /* @__PURE__ */ jsxs(
                    ...
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxs(Link, { to: "/wissen/dsgvo-leitfaeden", children: [
...
export {
  BetroffenenrechteGuide as default
};
