...
const ScrollTransformationPerfected = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (shouldBeSticky) {
        ...
        const scrolledSinceSticky2 = Math.max(0, currentScrollY - stickyStartScrollY);
        progress = totalStickyDistance > 0 ? scrolledSinceSticky2 / totalStickyDistance : 0;
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      style: { height: "300vh" },
      children: [
        /* @__PURE__ */ jsx("div", { className: "fixed top-4 left-4 z-50 bg-green-600 text-white px-3 py-1 rounded text-sm", children: "PERFECTED: Your Perfect Position" }),
        /* @__PURE__ */ jsx("div", { className: cn(
          ...
          /* @__PURE__ */ jsx("div", { className: cn(
            ...
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 max-w-md mx-auto", children: "PERFECTED: Basiert auf deiner perfekten Sticky-Position (SectionTop: ~62px)" }),
...
const TestPerfected = () => {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(ScrollTransformationPerfected, {}),
