...
const SitemapSEO = () => {
  ...
  const availablePages = sitemapCategories.reduce(
    (acc, cat) => acc + cat.items.filter((item) => item.available).length,
    0
  );
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50 py-8 px-4", children: /* @__PURE__ */ jsx("div", { className: "max-w-6xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "bg-gray-100 rounded-lg p-8", children: [
    /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 border-b-4 border-blue-600 pb-2 mb-6", children: "🗺️ Marsstein Compliance Platform - Sitemap" }),
    /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 p-4 rounded-lg mb-8 text-center", children: [
      /* @__PURE__ */ jsxs("strong", { className: "text-blue-900", children: [
        "Gesamt: ",
        totalPages,
        " Seiten"
      ] }),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("span", { children: [
                ...
                " ",
                category.title,
                /* @__PURE__ */ jsxs("span", { className: "text-sm font-normal ml-2", children: [
                  "(",
                  categoryAvailable,
                  "/",
                  categoryTotal,
              ...
              /* @__PURE__ */ jsx("span", { className: `transition-transform duration-300 ${isExpanded(category.id) ? "rotate-90" : ""}`, children: "▶" })
            ]
          }
        ),
        /* @__PURE__ */ jsx("div", { className: `overflow-hidden transition-all duration-300 ${isExpanded(category.id) ? "max-h-[3000px]" : "max-h-0"}`, children: /* @__PURE__ */ jsx("div", { className: "p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: category.items.map((item, index) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs(
                "a",
                {
                  ...
                  onClick: !item.available ? (e) => e.preventDefault() : void 0,
                  children: [
                    item.title,
                    !item.available && /* @__PURE__ */ jsx("span", { className: "text-red-500 ml-2", children: "(Nicht verfügbar)" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-500 mt-1", children: [
                "URL: ",
                /* @__PURE__ */ jsx("code", { className: "bg-gray-200 px-1 rounded", children: item.url })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600 mt-1", children: item.description })
            ]
          },
          index
        )) }) })
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-8 p-4 bg-gray-100 rounded-lg", children: [
      /* @__PURE__ */ jsx("h3", { className: "font-semibold mb-2", children: "Prioritäts-Legende:" }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-6 flex-wrap", children: [
        /* @__PURE__ */ jsxs("span", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "w-4 h-4 bg-red-500 mr-2" }),
          " Hoch (Kritische Seiten)"
        ] }),
        /* @__PURE__ */ jsxs("span", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "w-4 h-4 bg-yellow-500 mr-2" }),
          " Mittel (Wichtige Seiten)"
        ] }),
        /* @__PURE__ */ jsxs("span", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "w-4 h-4 bg-green-500 mr-2" }),
          " Niedrig (Zusätzliche Seiten)"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-4 p-4 bg-yellow-50 rounded-lg", children: [
      /* @__PURE__ */ jsx("h3", { className: "font-semibold mb-2 text-yellow-900", children: "⚠️ Hinweis zu nicht verfügbaren Seiten:" }),
      /* @__PURE__ */ jsx("p", { className: "text-yellow-800", children: 'Einige Seiten sind derzeit noch in Entwicklung. Die als "Nicht verfügbar" markierten Seiten werden in Kürze hinzugefügt. Alle verfügbaren Seiten sind voll funktionsfähig und bieten umfassende Compliance-Informationen.' })
    ] })
  ] }) }) });
};
export {
  SitemapSEO as default
};
