...
import { AlertTriangle, Target, Shield, Users, CheckCircle, Bookmark, Download, Printer, Share2, Clock, Circle, ArrowLeft, ArrowRight, BookOpen } from "lucide-react";
...
const DataBreachNotfallGuide = () => {
  ...
  const handleChapterComplete = (chapterId) => {
    setCompletedChapters(
      (prev) => prev.includes(chapterId) ? prev.filter((id) => id !== chapterId) : [...prev, chapterId]
    );
  };
  useEffect(() => {
    const handleScroll = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900", children: [
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsx("div", { className: "pt-20", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 py-12", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-3 mb-6", children: [
              /* @__PURE__ */ jsx("div", { className: "p-3 bg-red-500 rounded-xl", children: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-8 w-8 text-white" }) }),
              /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-6xl font-bold text-white", children: "Data Breach Notfallplan" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-xl text-slate-300 mb-8 max-w-4xl mx-auto", children: "Professioneller Leitfaden für die DSGVO-konforme Behandlung von Datenschutzverletzungen. Von Sofortmaßnahmen bis zur langfristigen Prävention." }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-4 mb-8", children: [
              /* @__PURE__ */ jsxs(Badge, { variant: "outline", className: "bg-orange-500/10 border-orange-500/20 text-orange-300", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-4 gap-8", children: [
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxs("div", { className: "sticky top-24", children: [
          /* @__PURE__ */ jsx(Card, { className: "bg-slate-800/50 border-slate-700 mb-6", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-white mb-4", children: "Fortschritt" }),
            /* @__PURE__ */ jsx(Progress, { value: readingProgress, className: "mb-4" }),
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-slate-300 mb-4", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-3", children: chapters.map((chapter, index) => /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  currentChapter === index ? "bg-blue-500/20 border border-blue-500/30 text-blue-300" : "bg-slate-700/30 border border-slate-600/30 text-slate-300 hover:bg-slate-700/50"
                ),
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  completedChapters.includes(chapter.id) ? /* @__PURE__ */ jsx(CheckCircle, { className: "h-5 w-5 text-green-400" }) : /* @__PURE__ */ jsx("div", { className: "w-5 h-5 border-2 border-slate-500 rounded-full" }),
                  /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("div", { className: "font-semibold text-sm", children: chapter.title }) })
                ] })
              },
              chapter.id
            )) })
          ...
          /* @__PURE__ */ jsx(Card, { className: "bg-slate-800/50 border-slate-700", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-white mb-4", children: "Schnellaktionen" }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxs(
                Button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(Bookmark, { className: cn("h-4 w-4 mr-2", bookmarked && "fill-current") }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3", children: [
          /* @__PURE__ */ jsx(Card, { className: "bg-slate-800/50 border-slate-700", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-8", ref: contentRef, children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-8", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-white mb-2", children: chapters[currentChapter].title }),
                /* @__PURE__ */ jsx("p", { className: "text-lg text-slate-300", children: chapters[currentChapter].subtitle })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxs(
                  Button,
                  {
                    ...
                    size: "sm",
                    children: [
                      completedChapters.includes(chapters[currentChapter].id) ? /* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 mr-2" }) : /* @__PURE__ */ jsx(Circle, { className: "h-4 w-4 mr-2" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mt-12 pt-8 border-t border-slate-700", children: [
              /* @__PURE__ */ jsxs(
                Button,
                {
              ...
              /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxs("span", { className: "text-sm text-slate-400", children: [
                "Kapitel ",
                currentChapter + 1,
                " von ",
                chapters.length
          ...
          currentChapter === chapters.length - 1 && /* @__PURE__ */ jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              animate: { opacity: 1, y: 0 },
              ...
              className: "mt-8",
              children: /* @__PURE__ */ jsx(Card, { className: "bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-8 text-center", children: [
                /* @__PURE__ */ jsx(CheckCircle, { className: "h-16 w-16 text-green-400 mx-auto mb-4" }),
                /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-white mb-4", children: "Herzlichen Glückwunsch!" }),
                /* @__PURE__ */ jsx("p", { className: "text-slate-300 mb-6", children: "Sie haben den Data Breach Notfallplan erfolgreich abgeschlossen. Sie sind nun bestens vorbereitet auf Datenschutzverletzungen und können im Ernstfall professionell und DSGVO-konform reagieren." }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-4", children: [
                  /* @__PURE__ */ jsx(Button, { asChild: true, children: /* @__PURE__ */ jsxs(Link, { to: "/wissen/dsgvo-leitfaeden", children: [
...
export {
  DataBreachNotfallGuide as default
};
