  ...
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0 shadow-2xl border-0 bg-background/95 backdrop-blur-xl max-w-2xl">
        ...
        <DialogDescription className="sr-only">Durchsuchen Sie alle Seiten und Inhalte</DialogDescription>
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-lg px-3 py-3 text-sm outline-none transition-colors data-[disabled=true]:pointer-events-none data-[selected='true']:bg-primary/10 data-[selected=true]:text-primary data-[disabled=true]:opacity-50 hover:bg-muted/50",
      className
    )}
    {...props}
  />
