      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            无论您的企业规模如何——Marsstein自动化合规，
            管理风险并建立持续信任。一切尽在一个AI驱动的平台中。
          </p>
        </div>
