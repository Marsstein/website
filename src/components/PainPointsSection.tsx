...
export const PainPointsSection: React.FC = () => {
  const painPoints = [
    ...
    {
      icon: Clock,
      title: 'Endlose Audit-Marathons',
      description: 'Wochen der Vorbereitung, Berge von Dokumenten, gestresste Teams. Jedes. Einzelne. Mal.',
    ...
    },
    {
      ...
      description: 'Veraltete Richtlinien, fehlende Nachweise, inkonsistente Versionen. Ein Compliance-Albtraum.',
    ...
    {
      icon: Users,
      title: 'Überfordertes Team',
      description: 'Ihre Experten ertrinken in Routine-Aufgaben statt sich auf strategische Themen zu fokussieren.',
    ...
    },
    {
      ...
      description: 'Ein Datenleck und Ihr mühsam aufgebautes Vertrauen ist zerstört. Für immer.',
    ...
    {
      icon: Brain,
      title: 'KI-Regulierungs-Tsunami',
      description: 'EU AI Act, NIS2, DORA... Neue Gesetze kommen schneller als Sie mithalten können.',
