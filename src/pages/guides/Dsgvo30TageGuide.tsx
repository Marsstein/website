        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          <div className="text-center mb-12">
            ...
            >
              ...
              <span className="text-sm font-semibold text-blue-300">30-Tage Implementation</span>
              <Rocket className="h-5 w-5 text-indigo-400" />
            </motion.div>
            
            <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6">
              <span className="text-white">DSGVO in</span>
              <br />
              <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent">
                30 Tagen
              </span>
              <br />
              <span className="text-white">umsetzen</span>
            </h1>
            
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-8">
              <span className="font-semibold text-blue-300">Strukturierter Implementierungsplan</span> mit Checklisten, 
              Templates und Zeitplänen für vollständige DSGVO-Compliance.
            </p>
        ...
        <div className="container mx-auto max-w-4xl px-4 py-4">
          <div className="flex items-center justify-between mb-2">
            <div className="text-sm text-slate-400">
              Woche {currentChapterData.week} - Kapitel {currentChapter + 1} von {chapters.length}
            </div>
            <div className="text-sm text-slate-400">
      ...
      <div className="container mx-auto max-w-7xl px-4 py-8">
        <div className="grid lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="lg:sticky lg:top-32">
              <Card className="bg-slate-800/80 backdrop-blur-sm border-slate-700/50">
                <CardContent className="p-6">
                  <h3 className="text-lg font-semibold text-white mb-4">30-Tage-Plan</h3>
          ...
          <div className="lg:col-span-3">
            <Card className="bg-slate-800/80 backdrop-blur-sm border-slate-700/50 mb-8 overflow-hidden">
              <CardContent className="p-4 lg:p-8">
                ...
                {/* Chapter Navigation */}
                <div className="flex flex-col lg:flex-row items-center justify-between mt-8 lg:mt-12 pt-6 lg:pt-8 border-t border-slate-700/50 gap-4 lg:gap-0">
                  <Button
                    variant="outline"
                    onClick={prevChapter}
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    >
                      ...
                      <h4 className="font-semibold text-white group-hover:text-blue-300 transition-colors">{guide.title}</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-4">
                    Starten Sie mit unserer DSGVO-Software und erreichen Sie Compliance schneller. Automatische Workflows, vorgefertigte Templates und geführte Prozesse.
                  </p>
                  <Button
                    size="lg"
...
export default Dsgvo30TageGuide;