...
const Iso27001GuideZh: React.FC = () => {
  ...
  const sections = [
    { id: 'ueberblick', title: '概述', icon: Eye, readTime: '8 Min' },
    { id: 'geschichte', title: '历史与演变', icon: Calendar, readTime: '12 Min' },
    { id: 'grundlagen', title: 'ISMS基础', icon: BookOpen, readTime: '15 Min' },
    { id: 'rechtlicher-rahmen', title: '法律框架', icon: Scale, readTime: '10 Min' },
    { id: 'anforderungen', title: '要求（条款）', icon: CheckCircle2, readTime: '25 Min' },
    { id: 'sicherheitskontrollen', title: '安全控制', icon: Shield, readTime: '45 Min' },
    { id: 'risikomanagement', title: '风险管理', icon: AlertTriangle, readTime: '20 Min' },
    { id: 'implementierung', title: '实施', icon: Settings, readTime: '30 Min' },
    { id: 'dokumentation', title: '文档记录', icon: FileText, readTime: '18 Min' },
    { id: 'audit-assessment', title: '审计与评估', icon: Search, readTime: '22 Min' },
    { id: 'zertifizierung', title: '认证', icon: Award, readTime: '15 Min' },
    { id: 'aufrechterhaltung', title: '维护', icon: RotateCcw, readTime: '12 Min' },
    { id: 'integration-standards', title: '集成与标准', icon: Network, readTime: '14 Min' },
    { id: 'branchenspezifika', title: '行业特定', icon: Building2, readTime: '16 Min' },
    { id: 'vorteile-roi', title: '优势与投资回报', icon: TrendingUp, readTime: '12 Min' },
    { id: 'fallstudien', title: '案例研究', icon: BookOpen, readTime: '20 Min' },
    { id: 'tools-software', title: '工具与软件', icon: Code, readTime: '10 Min' },
    { id: 'ressourcen', title: '资源', icon: Download, readTime: '8 Min' }
  ];
  ...
  const controls = [
    ...
    },
    {
      ...
      description: '建立管理框架以启动和控制信息安全的实施',
      controls: [
        { 
          id: 'A.6.1', 
          title: '内部组织', 
    ...
    },
    {
      ...
      description: '识别组织资产并定义适当的保护责任',
      controls: [
        { id: 'A.8.1', title: '资产责任', description: 'Inventarisierung und Eigentumsverantwortung für Informationsvermögen' },
        { id: 'A.8.2', title: '信息分类', description: 'Klassifizierung von Informationen nach Schutzbedarf' },
        { id: 'A.8.3', title: '媒体处理', description: 'Handhabung von Wechselmedien gemäß Klassifizierungsschema' }
      ]
    },
    {
      domain: 'A.9 - 访问控制',
      ...
      controls: [
        { id: 'A.9.1', title: '访问控制的业务要求', description: 'Zugangskontrollpolicy und Benutzerzugriffsverwaltung' },
        { id: 'A.9.2', title: '用户访问管理', description: 'Registrierung, Bereitstellung und Widerruf von Benutzerzugriffen' },
        { id: 'A.9.3', title: '用户责任', description: 'Verwendung von geheimen Authentifizierungsinformationen' },
        { id: 'A.9.4', title: '系统访问控制', description: 'Autorisierte Nutzung und sichere Anmeldeverfahren' }
      ]
    },
    {
      domain: 'A.10 - 密码学',
      ...
      description: '确保正确和有效地使用密码学',
      controls: [
        { id: 'A.10.1', title: '密码控制', description: 'Policy für die Verwendung kryptographischer Kontrollen und Schlüsselverwaltung' }
      ]
    },
    {
      domain: 'A.11 - 物理和环境安全',
      ...
      description: '防止未经授权的物理访问、损坏和干扰',
      controls: [
        { id: 'A.11.1', title: '安全区域', description: 'Physischer Schutz und Zugangskontrollen für sichere Bereiche' },
        { id: 'A.11.2', title: '设备', description: 'Schutz von Ausrüstung vor Verlust, Beschädigung, Diebstahl oder Kompromittierung' }
      ]
    },
    {
      domain: 'A.12 - 运营安全',
      ...
      controls: [
        { id: 'A.12.1', title: '操作程序和责任', description: 'Dokumentierte Betriebsverfahren und Änderungsmanagement' },
        { id: 'A.12.2', title: '恶意软件防护', description: 'Erkennung und Prävention von Malware' },
        { id: 'A.12.3', title: '数据备份', description: 'Regelmäßige Sicherungskopien von Informationen und Software' },
        { id: 'A.12.4', title: '日志记录和监控', description: 'Aufzeichnung von Ereignissen und Schutz von Protokollinformationen' },
        { id: 'A.12.5', title: '操作软件控制', description: 'Kontrolle der Installation von Software auf Betriebssystemen' },
        { id: 'A.12.6', title: '技术漏洞管理', description: 'Rechtzeitige Informationen über und Management von technischen Schwachstellen' },
        { id: 'A.12.7', title: '信息系统审计考虑', description: 'Minimierung der Auswirkungen von Audit-Aktivitäten auf Betriebssysteme' }
      ]
    },
    {
      domain: 'A.13 - 通信安全',
      ...
      description: '确保网络和支持信息处理设施中信息的保护',
      controls: [
        { id: 'A.13.1', title: '网络安全管理', description: 'Management und Kontrolle von Netzwerken zum Schutz von Informationen' },
        { id: 'A.13.2', title: '信息传输', description: 'Wahrung der Sicherheit übertragener Informationen innerhalb und außerhalb der Organisation' }
      ]
    },
    {
      domain: 'A.14 - 系统获取、开发和维护',
      icon: Code,
      color: 'from-pink-500 to-rose-600',
      description: '确保信息安全是信息系统的组成部分',
      controls: [
        { id: 'A.14.1', title: '信息系统的安全要求', description: 'Spezifikation und Tests von Sicherheitsanforderungen' },
        { id: 'A.14.2', title: '开发和支持过程中的安全', description: 'Sichere Entwicklungsrichtlinien und -kontrollen' },
        { id: 'A.14.3', title: '测试数据', description: 'Schutz von Testdaten' }
      ]
    },
    {
      domain: 'A.15 - 供应商关系',
      ...
      description: '确保供应商可访问的组织资产的保护',
      controls: [
        { id: 'A.15.1', title: '供应商关系中的信息安全', description: 'Sicherheitsanforderungen für Lieferantenverträge' },
        { id: 'A.15.2', title: '供应商服务交付管理', description: 'Überwachung und Überprüfung von Lieferanten-Services' }
      ]
    },
    {
      domain: 'A.16 - 信息安全事件管理',
      icon: AlertTriangle,
      color: 'from-red-500 to-orange-600',
      description: '确保对信息安全事件管理采取一致和有效的方法',
      controls: [
        { id: 'A.16.1', title: '信息安全事件管理和改进', description: 'Verantwortlichkeiten, Verfahren und kontinuierliche Verbesserung der Vorfallbehandlung' }
      ]
    },
    {
      domain: 'A.17 - 业务连续性管理的信息安全方面',
      icon: Activity,
      color: 'from-violet-500 to-purple-600',
      description: '在不利条件下保持信息安全管理的连续性',
      controls: [
        { id: 'A.17.1', title: '信息安全连续性', description: 'Planung und Implementierung von Informationssicherheitskontinuität' },
        { id: 'A.17.2', title: '冗余', description: 'Verfügbarkeit von informationsverarbeitenden Einrichtungen' }
      ]
    },
    {
      domain: 'A.18 - 合规性',
      ...
      description: '避免违反法律、监管或合同义务',
      controls: [
        { id: 'A.18.1', title: '符合法律和合同要求', description: 'Identifikation und Erfüllung rechtlicher Anforderungen' },
        { id: 'A.18.2', title: '信息安全审查', description: 'Regelmäßige Überprüfung der Informationssicherheit' }
      ]
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="ISO 27001指南2024 – 逐步认证"
        description="了解ISO 27001认证：ISMS建设、控制、审计流程与成本。✓ 实用指南 ✓ 含检查清单。立即开始！"
        canonical="/zh/iso-27001-zhinan"
        keywords="ISO 27001指南, ISMS指南, ISO 27001认证, 信息安全"
      />
                        ...
                        <div className="space-y-8">
                          ...
                          <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 rounded-xl p-6 border border-slate-600">
                            ...
                            <div className="grid md:grid-cols-4 gap-4">
                              {[
                                { phase: 'Vorbereitung', duration: '3-6个月', color: 'bg-blue-500' },
                                { phase: '实施', duration: '6-12 Monate', color: 'bg-emerald-500' },
                                { phase: '认证', duration: '2-3 Monate', color: 'bg-purple-500' },
                                { phase: '维护', duration: 'Kontinuierlich', color: 'bg-orange-500' }
                              ].map((phase) => (
...
export default Iso27001GuideZh;