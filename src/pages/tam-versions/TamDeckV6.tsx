...
import { Users, Building, TrendingUp, ArrowRight, ArrowLeft, Briefcase, Zap } from 'lucide-react';

const TamDeckV6: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4 font-sans">
      <div
        className="aspect-[16/9] w-full max-w-7xl bg-[#F5F6F8] rounded-2xl shadow-large p-12 flex flex-col gap-6"
      ...
      >
        ...
        <main className="flex-grow grid grid-cols-[1fr_auto_1fr] gap-6 items-center">
          ...
          <div className="flex flex-col items-center justify-center h-full text-center gap-3">
            ...
            <div className="p-4 bg-white rounded-full shadow-md border border-gray-200 z-10">
