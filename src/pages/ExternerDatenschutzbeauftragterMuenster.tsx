  ...
  const faqs = [
    {
      ...
      answer: (<>
        Als Münsterer Unternehmen profitieren Sie von regionaler Nähe bei gleichzeitig{' '}
        <Link to="/wissen/kosten/externer-datenschutzbeauftragter-kosten" className="text-[#e24e1b] hover:underline">
          niedrigeren Kosten
        </Link>
        {' '}(ab 29€/Monat) im Vergleich zu einem internen DSB. Wir kennen die lokalen Gegebenheiten und typischen Branchen in Münster.
      </>)
    },
    {
    ...
    },
    {
      ...
      answer: (<>
        Ab 29€/Monat für kleine Unternehmen (bis 20 MA), 95€/Monat für mittlere Unternehmen (bis 50 MA). Alle Leistungen inklusive - keine regionalen Aufschläge für Münster.{' '}
    ...
    },
    {
      ...
      answer: (<>
        ...
        {' '}und haben bereits zahlreiche Unternehmen in der Region Münster erfolgreich DSGVO-konform aufgestellt.
      </>)
    }
  ];
