            ...
            <Card className="mt-12">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Link to="/assessment-center/data-protection-test" className="block p-4 bg-green-50 rounded-lg border-2 border-green-200 hover:border-green-300 transition-colors group">
                    <CheckCircle2 className="h-5 w-5 text-green-600 mb-2" />
                    <div className="font-medium">Datenschutz-Assessment</div>
                    <div className="text-sm text-gray-600">Prüfen Sie Ihre SaaS-Compliance kostenlos</div>
                  </Link>
                  <Link to="/branchen/saas-unternehmen" className="block p-4 bg-cyan-50 rounded-lg border-2 border-cyan-200 hover:border-cyan-300 transition-colors group">
                    <Cloud className="h-5 w-5 text-cyan-600 mb-2" />
                    <div className="font-medium">SaaS Solutions</div>
                    <div className="text-sm text-gray-600">Maßgeschneiderte SaaS-Compliance-Lösungen</div>
                  </Link>
                  <Link to="/wissen/compliance/soc2" className="block p-4 bg-purple-50 rounded-lg border-2 border-purple-200 hover:border-purple-300 transition-colors group">
                    <Shield className="h-5 w-5 text-purple-600 mb-2" />
                    <div className="font-medium">SOC 2 Compliance</div>
                    <div className="text-sm text-gray-600">SOC 2 Type II Zertifizierung für SaaS</div>
                  </Link>
                </div>
              </CardContent>
            </Card>
