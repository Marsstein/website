...
import { Shield, Lock, Key, CreditCard, Globe, Database, AlertTriangle, CheckCircle, ArrowRight, Code, FileText, Users, TrendingUp, Layers, GitBranch, Server, Cloud, Zap, BookOpen, BarChart3, Building2, CheckCircle2 } from 'lucide-react';
...
const FintechComplianceGuide = () => {
  ...
  // Navigation items for sticky navigation with scroll-margin-top
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <Helmet>
        ...
        <meta name="description" content="Komplette FinTech Compliance-Lösungen: PCI DSS Level 1, PSD2-konforme APIs & sichere Crypto-Asset-Verwaltung. 99.99% Uptime, < 15 Min Incident Response." />
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {navigationItems.map((item) => (
                    <li key={item.id}>
                      ...
                      >
                        <item.icon className="h-4 w-4 text-gray-500 group-hover:text-blue-600 dark:group-hover:text-blue-400" />
      ...
      <div className="max-w-7xl mx-auto px-4 mt-16">
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-800">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Vertiefen Sie Ihr Wissen mit diesen ergänzenden Guides und Tools
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href="/assessment-center/data-protection-test" className="group p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 rounded-xl border-2 border-green-200 dark:border-green-800 hover:border-green-400 dark:hover:border-green-600 transition-all hover:shadow-lg">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white">Datenschutz-Assessment</h3>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">Prüfen Sie Ihre FinTech-Compliance in unserem kostenlosen Assessment</p>
              <div className="flex items-center gap-2 text-green-600 dark:text-green-400 text-sm font-semibold">
                <span>Jetzt starten</span>
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </div>
            </a>
            <a href="/branchen/finanzdienstleister" className="group p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-xl border-2 border-blue-200 dark:border-blue-800 hover:border-blue-400 dark:hover:border-blue-600 transition-all hover:shadow-lg">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-blue-100 dark:bg-blue-900 rounded-lg group-hover:scale-110 transition-transform">
                  <Building2 className="h-6 w-6 text-blue-600 dark:text-blue-400" />
                </div>
                <h3 className="font-bold text-gray-900 dark:text-white">Finanzdienstleister Solutions</h3>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">Maßgeschneiderte Compliance-Lösungen für Banken und FinTechs</p>
              <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 text-sm font-semibold">
                <span>Mehr erfahren</span>
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </div>
            </a>
            <a href="/wissen/compliance/eu-ai-act" className="group p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 rounded-xl border-2 border-purple-200 dark:border-purple-800 hover:border-purple-400 dark:hover:border-purple-600 transition-all hover:shadow-lg">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-purple-100 dark:bg-purple-900 rounded-lg group-hover:scale-110 transition-transform">
                  <Shield className="h-6 w-6 text-purple-600 dark:text-purple-400" />
                </div>
                <h3 className="font-bold text-gray-900 dark:text-white">EU AI Act Guide</h3>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">KI-Compliance für FinTech-Anwendungen und Fraud Detection</p>
              <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400 text-sm font-semibold">
                <span>Zum Leitfaden</span>
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </div>
            </a>
          </div>
