...
const Soc2Guide: React.FC = () => {
  ...
  const sections = [
    ...
    { id: 'trust-principles', title: 'Trust Services Criteria', icon: Shield, readTime: '20 Min' },
    { id: 'types', title: 'Type I vs Type II', icon: GitBranch, readTime: '12 Min' },
    { id: 'scope', title: 'Scope Definition', icon: Target, readTime: '15 Min' },
    { id: 'security', title: 'Security Criteria', icon: Lock, readTime: '30 Min' },
    { id: 'availability', title: 'Availability Criteria', icon: Activity, readTime: '18 Min' },
    { id: 'processing', title: 'Processing Integrity', icon: Cpu, readTime: '18 Min' },
    { id: 'confidentiality', title: 'Confidentiality', icon: Eye, readTime: '15 Min' },
    { id: 'privacy', title: 'Privacy Criteria', icon: UserCheck, readTime: '20 Min' },
    { id: 'controls', title: 'Common Controls', icon: Settings, readTime: '35 Min' },
    { id: 'evidence', title: 'Evidence Collection', icon: FileText, readTime: '25 Min' },
    { id: 'audit-process', title: 'Audit Process', icon: Search, readTime: '22 Min' },
    { id: 'implementation', title: 'Implementation Guide', icon: Rocket, readTime: '30 Min' },
    { id: 'continuous', title: 'Continuous Monitoring', icon: Activity, readTime: '18 Min' },
    { id: 'tools', title: 'Tools & Automation', icon: Code, readTime: '15 Min' },
    { id: 'certification', title: 'Certification Path', icon: Award, readTime: '12 Min' },
    { id: 'benefits', title: 'Business Benefits', icon: TrendingUp, readTime: '10 Min' },
    { id: 'resources', title: 'Resources & Templates', icon: Download, readTime: '8 Min' }
  ];
          ...
          <div className="lg:col-span-3">
            <div ref={contentRef}>
              <Tabs value={activeSection} onValueChange={setActiveSection}>
                ...
                <TabsContent value="trust-principles" className="space-y-8">
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                ...
                <TabsContent value="confidentiality" className="space-y-8">
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                ...
                <TabsContent value="audit-process" className="space-y-8">
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
