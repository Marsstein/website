...
const AttractionDeckV1 = lazy(() => import('./attraction-versions/AttractionDeckV1'));

const decks = [
  { component: AttractionDeckV1, name: 'Traction', icon: Rocket },
];
