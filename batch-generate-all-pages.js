...
import ReactToHTMLConverter from './smart-react-converter.js';

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

// Vollständige Konfiguration aller 49 verbleibenden Seiten aus VolleSeiten.md
const PAGES_CONFIG = {
  compliance: [
    // DSGVO-Familie
    {
  ...
  'assessment-center': [
    ...
    },
    {
      ...
      sourceFile: 'src/pages/assessment-center/AIGovernanceCheck.tsx',
    ...
    },
    {
      ...
      sourceFile: 'src/pages/assessment-center/AIRiskAssessment.tsx',
      title: 'AI Risk Assessment für KI-Systeme',
      description: 'KI-Risikobewertung nach EU AI Act. Risikoklassen bestimmen. Maßnahmen ableiten. Kostenlos testen.'
    },
    {
      route: '/assessment-center/algorithmic-impact-assessment',
      sourceFile: 'src/pages/assessment-center/AlgorithmicImpactAssessment.tsx',
      title: 'Algorithmic Impact Assessment',
      description: 'Folgenabschätzung für algorithmische Systeme. Bias erkennen, Fairness sicherstellen. Jetzt prüfen.'
    },
    {
      route: '/assessment-center/breach-response-checklist',
      sourceFile: 'src/pages/assessment-center/BreachResponseChecklist.tsx',
      title: 'Data Breach Response Checklist',
      description: 'Datenpannen-Notfallplan. 72-Stunden-Meldepflicht erfüllen. Schritt-für-Schritt-Anleitung mit Vorlagen.'
    },
    {
      route: '/assessment-center/cookie-compliance-audit',
      sourceFile: 'src/pages/assessment-center/CookieComplianceAudit.tsx',
      title: 'Cookie Compliance Audit',
      description: 'Cookie-Banner DSGVO-konform gestalten. TCF 2.0 Compliance prüfen. Kostenlose Analyse in 5 Minuten.'
    },
    {
      route: '/assessment-center/datenschutz-readiness-assessment',
      sourceFile: 'src/pages/assessment-center/DatenschutzReadiness.tsx',
      title: 'Datenschutz Readiness Assessment',
      description: 'DSGVO-Reifegrad bewerten. Gap-Analyse mit Maßnahmenplan. Kostenlos in 15 Minuten.'
    },
    {
      route: '/assessment-center/dsgvo-compliance-checklist',
      sourceFile: 'src/pages/assessment-center/DSGVOComplianceChecklist.tsx',
      title: 'DSGVO Compliance Checklist',
      description: '100-Punkte DSGVO-Checkliste. Alle Anforderungen prüfen. Mit Umsetzungshinweisen.'
    },
    {
      route: '/assessment-center/vendor-assessment-template',
      sourceFile: 'src/pages/assessment-center/VendorAssessment.tsx',
      title: 'Vendor Assessment Template',
      description: 'Auftragsverarbeiter DSGVO-konform prüfen. Standardisierte Bewertung. Mit Vorlagen und Checklisten.'
    }
  ],
  ...
  tools: [
    ...
    },
    {
      ...
      sourceFile: 'src/pages/tools/CookieManagement.tsx',
    ...
    },
    {
      ...
      sourceFile: 'src/pages/tools/DSGVOScorecard.tsx',
      title: 'DSGVO Compliance Scorecard',
      description: 'DSGVO-Reifegrad messen. Benchmark mit Ihrer Branche. Prioritäten für Verbesserungen.'
    },
    {
      route: '/tools/dsgvo-email-template-generator',
      sourceFile: 'src/pages/tools/EmailGenerator.tsx',
      title: 'DSGVO Email Template Generator',
      description: 'DSGVO-konforme E-Mail-Vorlagen generieren. Betroffenenanfragen, Löschanträge und mehr.'
    }
  ],
  ...
  wissen: [
    ...
    {
      route: '/wissen/compliance-frameworks',
      sourceFile: 'src/pages/wissen/ComplianceFrameworks.tsx',
      title: 'Compliance Frameworks im Überblick',
      description: 'ISO 27001, SOC2, TISAX und mehr. Vergleich aller wichtigen Compliance-Standards.'
    },
    {
      route: '/wissen/cybersecurity',
      sourceFile: 'src/pages/wissen/Cybersecurity.tsx',
      title: 'Cybersecurity Best Practices',
      description: 'IT-Sicherheit nach BSI und ISO 27001. Incident Response, Pentesting, Security by Design.'
    },
    {
      route: '/wissen/dsgvo',
      sourceFile: 'src/pages/wissen/DSGVOGrundlagen.tsx',
    ...
    },
    {
      ...
      sourceFile: 'src/pages/wissen/DSGVOLeitfaeden.tsx',
      title: 'DSGVO Leitfäden und Praxishilfen',
      description: 'Praktische DSGVO-Leitfäden. Schritt-für-Schritt-Anleitungen für alle Anforderungen.'
    },
    {
      route: '/wissen/ki-datenschutz',
      sourceFile: 'src/pages/wissen/KIDatenschutz.tsx',
      title: 'KI & Datenschutz - Rechtliche Grundlagen',
      description: 'Datenschutz bei KI-Systemen. EU AI Act, DSGVO-Anforderungen, Bias-Vermeidung.'
    },
    {
      route: '/wissen/risk-management',
      sourceFile: 'src/pages/wissen/RiskManagement.tsx',
      title: 'Risk Management nach ISO 31000',
      description: 'Risikomanagement-Framework aufbauen. Risikoidentifikation, -bewertung und -behandlung.'
    }
  ],
  
  'wissen/branchen': [
    {
      route: '/wissen/branchen/edtech-privacy',
      sourceFile: 'src/pages/wissen/branchen/EdTechPrivacy.tsx',
      title: 'EdTech Privacy - Datenschutz im Bildungsbereich',
      description: 'DSGVO für EdTech-Unternehmen. Minderjährigen-Datenschutz, Schul-Compliance, internationale Anforderungen.'
    },
    {
      route: '/wissen/branchen/healthcare-ai-compliance',
      sourceFile: 'src/pages/wissen/branchen/HealthcareAI.tsx',
      title: 'Healthcare AI Compliance',
      description: 'KI-Compliance im Gesundheitswesen. MDR, DSGVO, EU AI Act für medizinische KI-Systeme.'
    },
    {
      route: '/wissen/branchen/insurtech-compliance',
      sourceFile: 'src/pages/wissen/branchen/InsurTech.tsx',
      title: 'InsurTech Compliance',
      description: 'Compliance für InsurTech-Startups. Solvency II, IDD, DSGVO. Digitale Versicherungslösungen compliant gestalten.'
    },
    {
      route: '/wissen/branchen/travel-compliance',
      sourceFile: 'src/pages/wissen/branchen/TravelCompliance.tsx',
      title: 'Travel & Tourism Compliance',
      description: 'DSGVO für Reiseunternehmen. PNR-Daten, internationale Transfers, Buchungsplattformen.'
    }
  ],
  
  'wissen/leitfaden': [
    {
      route: '/wissen/leitfaden/betroffenenrechte',
      sourceFile: 'src/pages/wissen/leitfaden/Betroffenenrechte.tsx',
      title: 'Betroffenenrechte nach DSGVO umsetzen',
      description: 'Auskunft, Löschung, Berichtigung. Alle Betroffenenrechte DSGVO-konform umsetzen.'
    },
    {
      route: '/wissen/leitfaden/data-breach-notfall',
      sourceFile: 'src/pages/wissen/leitfaden/DataBreach.tsx',
      title: 'Data Breach Notfallplan',
      description: 'Datenpanne in 72 Stunden melden. Schritt-für-Schritt Notfallplan mit Vorlagen.'
    },
    {
      route: '/wissen/leitfaden/dsfa-durchfuehrung',
      sourceFile: 'src/pages/wissen/leitfaden/DSFA.tsx',
      title: 'DSFA Datenschutz-Folgenabschätzung',
      description: 'DSFA/DPIA durchführen. Wann erforderlich? Schritt-für-Schritt Anleitung mit Vorlagen.'
    },
    {
      route: '/wissen/leitfaden/dsgvo-30-tage',
      sourceFile: 'src/pages/wissen/leitfaden/DSGVO30.tsx',
      title: 'DSGVO in 30 Tagen umsetzen',
      description: 'DSGVO-Compliance in 30 Tagen. Strukturierter Fahrplan mit täglichen Aufgaben.'
    },
    {
      route: '/wissen/leitfaden/dsgvo-grundlagen',
      sourceFile: 'src/pages/wissen/leitfaden/DSGVOGrundlagen.tsx',
      title: 'DSGVO Grundlagen - Einführung',
      description: 'DSGVO-Grundlagen für Einsteiger. Die wichtigsten Artikel und Pflichten verständlich erklärt.'
    },
    {
      route: '/wissen/leitfaden/tom-massnahmen',
      sourceFile: 'src/pages/wissen/leitfaden/TOM.tsx',
      title: 'TOM - Technische und organisatorische Maßnahmen',
      description: 'TOMs nach Art. 32 DSGVO. Checkliste mit 50+ Maßnahmen für Datensicherheit.'
    },
    {
      route: '/wissen/leitfaden/verarbeitungsverzeichnis',
      sourceFile: 'src/pages/wissen/leitfaden/Verarbeitungsverzeichnis.tsx',
      title: 'Verarbeitungsverzeichnis erstellen',
      description: 'Verzeichnis von Verarbeitungstätigkeiten nach Art. 30 DSGVO. Mit Excel-Vorlage.'
    },
    {
      route: '/wissen/leitfaden/website-dsgvo',
      sourceFile: 'src/pages/wissen/leitfaden/WebsiteDSGVO.tsx',
      title: 'Website DSGVO-konform gestalten',
      description: 'Datenschutzerklärung, Cookie-Banner, Kontaktformulare DSGVO-konform umsetzen.'
    }
  ],
  
  'wissen/rechtsprechung': [
    {
      route: '/wissen/rechtsprechung/amazon-luxemburg-2021',
      sourceFile: 'src/pages/wissen/rechtsprechung/AmazonLuxemburg.tsx',
      title: 'Amazon Luxemburg Urteil 2021',
      description: 'DSGVO-Rekordstrafe von 746 Mio. Euro. Was können Unternehmen daraus lernen?'
    },
    {
      route: '/wissen/rechtsprechung/facebook-fanpage',
      sourceFile: 'src/pages/wissen/rechtsprechung/FacebookFanpage.tsx',
      title: 'Facebook Fanpage Urteil',
      description: 'EuGH-Urteil zu Facebook Fanpages. Gemeinsame Verantwortlichkeit und Konsequenzen.'
    },
    {
      route: '/wissen/rechtsprechung/google-analytics-austria',
      sourceFile: 'src/pages/wissen/rechtsprechung/GoogleAnalytics.tsx',
      title: 'Google Analytics Austria Urteil',
      description: 'Österreichische Datenschutzbehörde erklärt Google Analytics für rechtswidrig. Was nun?'
    }
  ]
};

// Smart React zu HTML Konverter nutzen
...
async function generatePageModule(pageConfig, category) {
  ...
  // Versuche Smart Converter zu nutzen
  try {
    if (fs.existsSync(path.join(process.cwd(), sourceFile))) {
      content = await converter.convertFile(path.join(process.cwd(), sourceFile));
      console.log(`   ✅ React-Komponente konvertiert`);
    } else {
      console.log(`   ⚠️  Datei nicht gefunden: ${sourceFile}`);
      content = generateTemplateContent(title, description);
    }
  } catch (error) {
    console.log(`   ⚠️  Konvertierung fehlgeschlagen, nutze Template`);
    content = generateTemplateContent(title, description);
  }
  ...
  const outputDir = path.join(__dirname, 'scripts/content', category);
...
${exports}
  ...
  const indexFile = path.join(__dirname, 'scripts/content', category, 'index.mjs');
...
async function generateAllPages() {
  console.log('🚀 Starte Batch-Generierung aller 49 verbleibenden Seiten...\n');
...
if (args.includes('--help')) {
  console.log(`
Batch-Generator für alle 49 verbleibenden Marsstein Seiten

Verwendung:
  node batch-generate-all-pages.js [optionen]
...
Generiert automatisch:
  - 8 Compliance-Seiten
  - 6 Hauptseiten
  - 9 Assessment-Center-Seiten
  - 5 Tools-Seiten
  - 7 Wissens-Seiten
  - 4 Branchen-Wissens-Seiten
  - 8 Leitfaden-Seiten
  - 3 Rechtsprechungs-Seiten
  
Gesamt: 49 Seiten mit intelligenter React-zu-HTML Konvertierung
  `);
  process.exit(0);
}
