/**
 * Google Apps Script für Google Indexing API - VOLLSTÄNDIGE VERSION
 *
 * ALLE 234 URLs aus der marsstein.ai Sitemap
 *
 * SETUP:
 ...
 * 4. Klicke "Speichern"
 * 5. Führe "submitAll" aus
 *
 * FUNKTIONEN:
 * - submitAll(): Submitted ALLE 234 URLs (200 am ersten Tag, 34 am zweiten Tag)
 * - submitHighPriority(): Nur URLs mit Priorität >= 0.8 (67 URLs)
