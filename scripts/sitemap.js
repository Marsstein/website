...
const routes = [
  ...
  { url: '/externer-datenschutzbeauftragter-augsburg', priority: '0.7', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-berlin', priority: '0.9', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-bielefeld', priority: '0.7', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-bonn', priority: '0.7', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-chemnitz', priority: '0.7', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-cuxhaven', priority: '0.6', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-darmstadt', priority: '0.7', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-essen', priority: '0.8', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-halle', priority: '0.7', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-luebeck', priority: '0.7', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-mainz', priority: '0.8', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-wiesbaden', priority: '0.7', changefreq: 'weekly' },
  { url: '/externer-datenschutzbeauftragter-wuerzburg', priority: '0.7', changefreq: 'weekly' },
