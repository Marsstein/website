export default {
  ...
  description: 'Ihr zentrales Compliance-Dashboard. Alle Zertifizierungen und Audits im Überblick.',
  content: `
        ...
        <div class="container mx-auto px-6 relative z-10">
          <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">
              Compliance Dashboard - Marsstein
            </h1>
            <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Ihr zentrales Compliance-Dashboard. Alle Zertifizierungen und Audits im Überblick.
            </p>
