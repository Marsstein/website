        ...
        <div class="container mx-auto px-6 relative z-10">
          <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              DSGVO/GDPR konforme Datenschutzlösungen. KI-gestützte Compliance in 30 Tagen. Rechtssicher und automatisiert.
            </p>
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold text-[#0B1D2A] mb-8">
              Was ist DSGVO-Compliance für Ihr Unternehmen?
            </h2>
            <div class="prose prose-lg max-w-none text-gray-600">
              <p class="mb-6">
                DSGVO/GDPR konforme Datenschutzlösungen. KI-gestützte Compliance in 30 Tagen. Rechtssicher und automatisiert. Mit Marsstein erreichen Sie vollständige Compliance in Rekordzeit - 
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-5xl mx-auto">
            <h2 class="text-3xl font-bold text-[#0B1D2A] text-center mb-12">
              Ihr Weg zur DSGVO-Compliance in 4 Schritten
            </h2>
      ...
      <section class="py-20 bg-gradient-to-br from-[#0B1D2A] to-[#1a3a52]">
        <div class="container mx-auto px-6 text-center">
          <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">
            Starten Sie jetzt Ihre DSGVO-Compliance-Journey
          </h2>
