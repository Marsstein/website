        ...
        <div class="container mx-auto px-6 relative z-10">
          <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Datenschutz bei KI-Systemen. EU AI Act, DSGVO-Anforderungen, Bias-Vermeidung.
            </p>
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-4xl mx-auto">
            ...
            <p class="text-gray-600 mb-8">
              Marsstein bietet Ihnen eine umfassende Lösung für KI & Datenschutz - Rechtliche Grundlagen. 
      ...
      <section class="py-20 bg-[#0B1D2A]">
        <div class="container mx-auto px-6 text-center">
          <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">
            Bereit für KI & Datenschutz - Rechtliche Grundlagen?
          </h2>
