        ...
        <div class="container mx-auto px-6 relative z-10">
          <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">
              Compliance Frameworks im Überblick
            </h1>
            <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ISO 27001, SOC2, TISAX und mehr. Vergleich aller wichtigen Compliance-Standards.
            </p>
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold text-[#0B1D2A] mb-8">
              Was ist Compliance Frameworks im Überblick?
            </h2>
            <div class="prose prose-lg max-w-none text-gray-600">
              <p class="mb-6">
                ISO 27001, SOC2, TISAX und mehr. Vergleich aller wichtigen Compliance-Standards. Mit Marsstein erreichen Sie vollständige Compliance in Rekordzeit - 
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-5xl mx-auto">
            <h2 class="text-3xl font-bold text-[#0B1D2A] text-center mb-12">
              Ihr Weg zur Compliance in 4 Schritten
            </h2>
      ...
      <section class="py-20 bg-gradient-to-br from-[#0B1D2A] to-[#1a3a52]">
        <div class="container mx-auto px-6 text-center">
          <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">
            Starten Sie jetzt Ihre Compliance-Journey
          </h2>
