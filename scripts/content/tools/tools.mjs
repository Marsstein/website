        ...
        <div class="container mx-auto px-6 relative z-10">
          <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">
              Compliance Tools & Automatisierung
            </h1>
            <p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              KI-gestützte Compliance-Tools. DSGVO-Generator, Cookie-Management und mehr. Kostenlos testen.
            </p>
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-4xl mx-auto">
            ...
            <p class="text-gray-600 mb-8">
              Marsstein bietet Ihnen eine umfassende Lösung für Compliance Tools & Automatisierung. 
      ...
      <section class="py-20 bg-[#0B1D2A]">
        <div class="container mx-auto px-6 text-center">
          <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">
            Bereit für Compliance Tools & Automatisierung?
          </h2>
