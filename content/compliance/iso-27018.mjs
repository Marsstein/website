export default {
  ...
  description: 'Umfassender Leitfaden für den Schutz personenbezogener Daten in Public Cloud Services.                Von der PII-Klassifizierung bis zur vollständigen Zertifiz',
