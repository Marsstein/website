export default {
  route: '/branchen/logistik',
  title: 'Logistik',
  description: 'Meistern Sie DSGVO, EU AI Act und ISO 27001 für intelligente Supply Chains                     und vertrauensvolle Sendungsverfolgung.',
  content: `
    <>
      <SEOHead>
      <div>
              ...
              <div>
                <div class="space-y-6">
                  <div>
                    ...
                    <span class="text-sm font-medium">Logistikbranche</span>
                  </div>
                  ...
                  <div>
                    <a href="/contact?demo=true&industry=logistics">
                      <Button>
                        <Truck class="mr-2 h-5 w-5" ></Truck>
                        Logistics Demo
                        <ArrowRight>
                      </Button>
                    </a>
                ...
                <div class="relative">
                  <Card>
                    <div class="space-y-4">
                      <div class="flex items-center justify-between">
                        <h3 class="font-bold text-lg">Logistics Compliance Center</h3>
                        <Badge class="bg-green-100 text-green-700">Route-Ready</Badge>
                      </div>
                  ...
                  <div>
                    <div class="flex items-center gap-2">
                      <Route class="h-4 w-4 text-indigo-500" ></Route>
                      <span class="text-sm font-medium">Smart-Ready</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <Card>
                    <div class="space-y-4">
                      <div class="flex items-start justify-between">
                        <div class="flex items-center gap-3">
                          <point.icon class="h-6 w-6 text-indigo-600" ></point>
                          <div>
