export default {
  ...
  title: 'E Commerce',
  description: 'Meistern Sie DSGVO, EU AI Act und ISO 27001 für vertrauensvolle,                     profitable E-Commerce-Erlebnisse ohne Compliance-Risiken.',
  content: `
    <>
      <SEOHead>
      <div>
            ...
            <div class="max-w-5xl mx-auto">
              <div>
                <div class="space-y-6">
                  ...
                  <h1>
                    Compliance für
                    <span class="bg-gradient-to-r from-green-600 to-teal-600 bg-clip-text text-transparent block mt-2">
                      E-Commerce
                    </span>
                  </h1>
                  ...
                  <div>
                    <a href="/contact?demo=true&industry=ecommerce">
                      <Button>
                        <ShoppingCart class="mr-2 h-5 w-5" ></ShoppingCart>
                        E-Commerce Demo
                        <ArrowRight>
                      </Button>
                    </a>
                    <Button size="lg" variant="outline" class="group">
                      <Cookie class="mr-2 h-5 w-5" ></Cookie>
                ...
                <div class="relative">
                  <Card>
                    <div class="space-y-4">
                      <div class="flex items-center justify-between">
                        <h3 class="font-bold text-lg">E-Commerce Compliance Hub</h3>
                  ...
                  <div>
                    <div class="flex items-center gap-2">
                      <Euro class="h-4 w-4 text-green-500" ></Euro>
