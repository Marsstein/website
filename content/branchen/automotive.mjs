export default {
  route: '/branchen/automotive',
  title: 'Automotive',
  description: 'Meistern Sie DSGVO, EU AI Act und ISO 27001 für zukunftssichere                     Connected Cars und autonome Fahrzeuge.',
  content: `
    <>
      <SEOHead>
      <div>
            ...
            <div class="max-w-5xl mx-auto">
              <div>
                <div class="space-y-6">
                  ...
                  <div>
                    <a href="/contact?demo=true&industry=automotive">
                      <Button>
                        <Car class="mr-2 h-5 w-5" ></Car>
                        Automotive Demo
                        <ArrowRight>
                      </Button>
                    </a>
                ...
                <div class="relative">
                  <Card>
                    <div class="space-y-4">
                      <div class="flex items-center justify-between">
                        <h3 class="font-bold text-lg">Automotive Compliance Center</h3>
                        <Badge class="bg-green-100 text-green-700">Road-Ready</Badge>
                      </div>
                  ...
                  <div>
                    <div class="flex items-center gap-2">
                      <Zap class="h-4 w-4 text-blue-500" ></Zap>
                      <span class="text-sm font-medium">Auto-Ready</span>
                    </div>
                  </div>
                </div>
              </div>
