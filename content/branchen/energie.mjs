export default {
  ...
  title: 'Energie',
  description: 'Meistern Sie DSGVO, EU AI Act und ISO 27001 für sichere Smart Grids                     und vertrauensvolle Energiedienstleistungen.',
  content: `
    <>
      <SEOHead>
      <div>
              ...
              <div>
                <div class="space-y-6">
                  <div>
                    ...
                    <span class="text-sm font-medium">Energiebranche</span>
                  </div>
                  ...
                  <div>
                    <a href="/contact?demo=true&industry=energy">
                      <Button>
                        <Zap class="mr-2 h-5 w-5" ></Zap>
                        Energy Demo
                        <ArrowRight>
                      </Button>
                    </a>
                ...
                <div class="relative">
                  <Card>
                    <div class="space-y-4">
                      <div class="flex items-center justify-between">
                        <h3 class="font-bold text-lg">Energy Compliance Center</h3>
                        <Badge class="bg-green-100 text-green-700">Grid-Ready</Badge>
                      </div>
                  ...
                  <div>
                    <div class="flex items-center gap-2">
                      <Sun class="h-4 w-4 text-yellow-500" ></Sun>
                      <span class="text-sm font-medium">Green-Ready</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <Card>
                    <div class="space-y-4">
                      <div class="flex items-start justify-between">
                        <div class="flex items-center gap-3">
                          <point.icon class="h-6 w-6 text-yellow-600" ></point>
                          <div>
