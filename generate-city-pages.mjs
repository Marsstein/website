...
const generateCityPage = (city) => {
  ...
  const industriesArray = city.industries.map((ind, idx) =>
    `              { icon: ${getIndustryIcon(idx)}, title: '${ind.name}', desc: '${ind.description}' }`
  ).join(',\n');
...
const ${componentName}: React.FC = () => {
  const localBenefits = [
    {
      icon: MapPin,
      title: '${city.state}-Expertise',
      description: 'Kenntnis der ${city.stateAuthority} und typischer Compliance-Anforderungen in der Region ${city.cityName}'
    },
    {
      icon: Users,
      title: 'Branchenkenntnis',
      description: 'Spezialisierung auf ${city.cityName}er Wirtschaftszweige: ${city.industries.slice(0, 3).map(i => i.name).join(', ')}'
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      description: 'Erfolgreiche DSGVO-Umsetzungen bei KMUs in ${city.cityName}, ${city.state} und ganz Deutschland'
    }
  ];
  ...
  const faqs = [
    ...
    {
      question: "Welche Branchen in ${city.cityName} betreuen Sie?",
      answer: "Wir haben Expertise in typischen ${city.cityName}er Wirtschaftszweigen: ${city.industries.map(i => i.name).join(', ')}."
    },
    {
    ...
    "@graph": [
      {
        ...
        "name": "MARSSTEIN - Externer Datenschutzbeauftragter ${city.cityName}",
        "description": "Externer Datenschutzbeauftragter für Unternehmen in ${city.cityName}. Zertifizierte DSGVO-Expertise ab 29€/Monat. Flexible digitale Beratung mit 24h Support-Reaktionszeit.",
        "url": "https://marsstein.ai/externer-datenschutzbeauftragter-${city.citySlug}",
          ...
          "itemListElement": [
            {
              ...
              "itemOffered": {
                "@type": "Service",
                "name": "Externer DSB für kleine Unternehmen ${city.cityName}",
                "description": "Datenschutzbeauftragter für Unternehmen bis 20 Mitarbeiter in ${city.cityName}"
              },
              "price": "29",
              "priceCurrency": "EUR",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 3,
            "name": "${city.cityName}",
            "item": "https://marsstein.ai/externer-datenschutzbeauftragter-${city.citySlug}"
          }
        ]
      }
    ]
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      <SEOHead
        title="Externer Datenschutzbeauftragter ${city.cityName} 2025 | Ab 29€/Monat"
        description="Externer Datenschutzbeauftragter in ${city.cityName} gesucht? ✓ Zertifizierte DSGVO-Experten ✓ Digitale Beratung mit 24h Support ✓ Ab 29€/Monat ✓ Für Unternehmen in ${city.cityName} & Umgebung"
        canonical="/externer-datenschutzbeauftragter-${city.citySlug}"
      ...
      <section className="bg-gray-50 py-4 border-b border-gray-200">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-semibold">${city.cityName}</span>
          </nav>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold text-[#e24e1b]">Ihr Datenschutzbeauftragter in ${city.cityName}</span>
            </motion.div>
            ...
            >
              Externer Datenschutzbeauftragter ${city.cityName}
            </motion.h1>
            ...
            >
              <span className="font-semibold text-[#232323]">Zertifizierte DSGVO-Expertise für Unternehmen in ${city.cityName}.</span>
              <br />
            ...
            >
              ...
              >
                <Link to="/contact">
                  ...
                  Kostenlose Beratung ${city.cityName}
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-[#232323] mb-6">
              Ihr Datenschutzbeauftragter für ${city.cityName} & Region
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Warum Unternehmen in ${city.cityName} und ${city.nearbyCity} auf unsere Expertise vertrauen
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-[#232323] mb-6">
              Transparente Preise für ${city.cityName}er Unternehmen
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            >
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                <Badge className="bg-gradient-to-r from-[#e24e1b] to-[#ea580c] text-white px-4 py-1 border-0 shadow-lg">
                  ...
                  BELIEBT IN ${city.cityName.toUpperCase()}
                </Badge>
              </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-[#232323] mb-2">Keine versteckten Kosten für ${city.cityName}</h3>
                    <p className="text-gray-700">
                      Anders als viele regionale Anbieter berechnen wir <span className="font-bold text-[#39B37B]">keine Anfahrtspauschalen oder regionalen Aufschläge</span> für ${city.cityName} und Umgebung.
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-[#232323] mb-6">
              Typische Branchen in ${city.cityName}, die wir betreuen
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-[#232323] mb-4">
              Häufige Fragen von Unternehmen in ${city.cityName}
            </h2>
          </motion.div>
          ...
          >
            ...
            >
              <Link to="/contact">
                Kostenlose Beratung für ${city.cityName} anfragen
                <ChevronRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </motion.div>
...
${city.nearbyCity.split(', ').map(nearbyCity => {
  const slug = nearbyCity.toLowerCase()
    .replace(/ä/g, 'ae')
    .replace(/ö/g, 'oe')
    .replace(/ü/g, 'ue')
    .replace(/ß/g, 'ss')
        ...
        <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
              Bereit für DSGVO-Compliance in ${city.cityName}?
            </h2>
            <p className="text-xl sm:text-2xl text-white/95 mb-10 max-w-3xl mx-auto">
              Starten Sie noch heute mit Ihrem externen Datenschutzbeauftragten in ${city.cityName}. Ab 29€/Monat. Digitale Beratung mit 24h Support.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <Link to="/contact">
                  <Phone className="mr-2 h-5 w-5" />
                  Jetzt Beratung ${city.cityName} anfragen
                  <ChevronRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button
...
function getIndustryIcon(index) {
  const icons = ['Building2', 'Rocket', 'Users', 'Building2', 'CheckCircle2', 'Award'];
...
cityData.forEach((city, index) => {
  const componentName = city.cityName.replace(/[äöüß\s-]/g, (match) => {
    const map = { 'ä': 'ae', 'ö': 'oe', 'ü': 'ue', 'ß': 'ss', ' ': '', '-': '' };
    return map[match] || match;
  });

  const filename = `ExternerDatenschutzbeauftragter${componentName}.tsx`;
  const filepath = path.join(__dirname, 'src', 'pages', filename);

  const content = generateCityPage(city);
  fs.writeFileSync(filepath, content, 'utf8');

  console.log(`✓ Generated ${index + 1}/${cityData.length}: ${filename}`);
});

console.log('\n✅ All city pages generated successfully!');
console.log('\n📝 Next steps:');
console.log('1. Add routes to App.tsx');
console.log('2. Test the pages in the browser');
console.log('3. Update sitemap.js with new URLs');
